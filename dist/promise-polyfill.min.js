!(function (t, e) {
    ...
    try {
      ...
      if (e && ("object" == typeof e || "function" == typeof e)) {
        var n,
          o,
          r = e.then;
        if (e instanceof f) return (t._state = 3), (t._value = e), void l(t);
  ...
  function l(t) {
    ...
    for (var e = 0, n = t._deferreds.length; n > e; e++) u(t, t._deferreds[e]);
    t._deferreds = null;
  }
  function s(t, e) {
    var n = !1;
  ...
  (f.prototype.catch = function (t) {
    ...
    (f.race = function (t) {
      return new f(function (e, n) {
        ...
        for (var o = 0, i = t.length; i > o; o++) f.resolve(t[o]).then(e, n);
      });
    }),
    (f._immediateFn =
